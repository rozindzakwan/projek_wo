...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('bootLogin/fonts/font-awesome-4.7.0/css/font-awesome.min.css ') }}">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('bootLogin/fonts/iconic/css/material-design-iconic-font.min.css ') }}">
    <!--===============================================================================================-->
        ...
        <div class="container-login100" style="background-color: darkgray;">
            <div class="wrap-login100">
                <div class="text-center">
                    <span>
                        <img src="{{ asset('foto/logo.jpg') }}" alt="" srcset="" width="200px" height="200px">
                    </span>
                </div>
                <form class="login100-form validate-form" action="{{ route('login.store') }}" method="POST">
                    ...
                    <div class="text-center">
                        <!-- <a class="txt2 text-warning" href="http://127.0.0.1:8000/"> -->
                        <a class="txt2 text-warning" href="dashboardUser">
                            Ke Dashboard
                        </a>
                    </div>
